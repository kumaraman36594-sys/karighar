...
export const SellerLoginScreen: React.FC<SellerLoginScreenProps> = ({
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-[#FDFBF7] flex flex-col justify-between p-4 sm:p-6 max-w-md w-full mx-auto">
      ...
      <div>
        ...
        {/* Input Field */}
        <div className="bg-white rounded-xl p-4 sm:p-5 border border-stone-200 shadow-xs mb-4">
          <label className="block text-xs font-bold text-stone-600 uppercase tracking-wider mb-2">
            मोबाइल नंबर (Mobile Number)
          </label>
          <div className="flex items-center gap-3 border-2 border-stone-300 focus-within:border-[#B4431E] rounded-xl px-4 py-2.5 bg-stone-50/50 h-14 transition-colors">
            <span className="text-lg font-extrabold text-stone-900 flex items-center gap-1 shrink-0">
              🇮🇳 +91
            </span>
            ...
            <input
              ...
              className="w-full text-xl font-extrabold tracking-wider text-stone-900 focus:outline-hidden bg-transparent placeholder:text-stone-300"
            />
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 my-3">
          {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map((digit) => (
            <button
              ...
              className="min-h-[50px] h-12 rounded-xl bg-white hover:bg-amber-50/50 active:bg-amber-100/60 border border-stone-200 text-xl font-bold text-stone-800 shadow-xs flex items-center justify-center transition-all cursor-pointer select-none active:scale-95"
            >
              {digit}
            </button>
          ))}
          <button
            ...
            className="min-h-[50px] h-12 rounded-xl bg-stone-100 hover:bg-stone-200 active:bg-stone-300 border border-stone-200 text-xs font-bold text-stone-600 shadow-xs flex items-center justify-center transition-all cursor-pointer select-none"
          >
            हटाएं (Clear)
          </button>
          <button
          ...
          <button
            ...
            className="min-h-[50px] h-12 rounded-xl bg-stone-100 hover:bg-stone-200 active:bg-stone-300 border border-stone-200 text-sm font-bold text-stone-700 shadow-xs flex items-center justify-center transition-all cursor-pointer select-none"
          >
            ⌫ मिटाएं
          </button>
        </div>
